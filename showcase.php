...
<body>
    ...
    <div class="relative flex flex-col h-[75vh] justify-center items-center text-secondary cursor-default select-none">
        <h1 class="text-5xl md:text-7xl font-satisfy font-bold text-center w-full p-5 md:p-10">Showcase</h1>
        <p class="font-bold uppercase tracking-wider">About our Resort</p>
        <a class="scroll-explore-cue" href="#showcase-content" aria-label="Scroll down to explore the showcase">
            <span>Scroll to explore</span>
            <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M12 5v13m0 0 5-5m-5 5-5-5"/></svg>
        </a>
    ...
    <div id="showcase-content" class="flex md:flex-row flex-col justify-center flex-wrap bg-gradient-to-br bg-secondary gap-5 select-none">
        <!-- Showcase component -->
        <div class="grid grid-cols-1 md:grid-cols-2 pt-24 md:pt-40 pb-16 md:pb-20 md:px-48 px-5 sm:px-10 gap-8 md:gap-12 justify-center items-center">
            <div class="w-full md:col-span-1 col-span-2 text-primary md:text-end text-center leading-3">
                <h1 class="text-4xl md:text-6xl font-satisfy font-bold mb-8">A Resort Like No Other...</h1>
            ...
            <div class="w-full h-72 md:h-[500px] md:col-span-1 col-span-1 shadow-2xl shadow-black overflow-hidden">
                <img class="w-full h-full object-cover" src="/assets/showcase-7.jpg" />
            </div>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 pt-16 md:pt-40 pb-16 md:pb-20 md:px-48 px-5 sm:px-10 gap-8 md:gap-12 justify-center items-center">
            <div class="w-full h-72 md:h-[500px] md:col-span-1 col-span-1 md:order-1 order-2 shadow-2xl shadow-black overflow-hidden">
            ...
            <div class="w-full md:col-span-1 col-span-2 md:order-2 order-1 text-primary md:text-left text-center leading-3">
                <h1 class="text-4xl md:text-5xl font-satisfy font-bold mb-8">Romantic Nights Under the Stars</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 pt-16 md:pt-40 pb-16 md:pb-20 md:px-48 px-5 sm:px-10 gap-8 md:gap-12 justify-center items-center">
            <div class="w-full md:col-span-1 col-span-2 text-primary md:text-end text-center leading-3">
                <h1 class="text-4xl md:text-5xl font-satisfy font-bold mb-8">Indulge in World-Class Amenities</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 pt-16 md:pt-40 pb-16 md:pb-20 md:px-48 px-5 sm:px-10 gap-8 md:gap-12 justify-center items-center">
            ...
            <div class="w-full md:col-span-1 col-span-2 md:order-2 order-1 text-primary md:text-left text-center leading-3">
                <h1 class="text-4xl md:text-5xl font-satisfy font-bold mb-8">Crafted for Unforgettable Experiences</h1>
