...
<body class="bg-gradient-to-br from-slate-950 to-violet-950">
    ...
    <div class="m-5 md:m-10 flex flex-col gap-10 items-center">
        <div class="bg-gradient-to-t from-slate-300 to-slate-200 p-5 md:p-10 flex flex-col gap-5 rounded-lg shadow-xl text-center items-center md:w-1/2 w-full">
            <h1 class="font-satisfy text-4xl md:text-5xl">Where to find?</h1>
